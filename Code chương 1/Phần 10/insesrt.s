	*	Kiểm tra bảng để tìm kết quả khớp - lưu trữ mục nhập mới ở cuối nếu không tìm thấy kết quả khớp, mở rộng insert.s
...
Main
		...
		CMP		R3, #0		        ; Danh sách trống
		BEQ 	Insert			    ; lưu trữ danh sách
		LDR		R4, [R0], #4		; Nếu không, nhập phần tử đầu
Loop
...
Insert ADD		R3, R3, #1		    ; Tăng số phần tử
